import { definePlugin } from "./decky-shim";
...
function PluginContent() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", ...themeStyle }}>
      <TabBar
        tabs={TABS}
        activeId={active}
      ...
      <div style={{ display: active === "typechart" ? "block" : "none" }}>
        <TypeChartView />
      </div>
      <div style={{ display: active === "party" ? "block" : "none" }}>
        <PartyView />
      </div>
