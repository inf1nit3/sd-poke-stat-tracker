...
function HomeView() {
    ...
    if (!info) {
        return (window.SP_JSX.jsxs(window.DFL.PanelSection, { title: "Pok\u00E9mon Essentials Overlay", children: [window.SP_JSX.jsx(window.DFL.PanelSectionRow, { children: window.SP_JSX.jsx(window.DFL.Focusable, { onActivate: () => { }, style: {
                            ...
                            borderRadius: "6px",
                            lineHeight: "1.4",
                        }, children: "Plugin data isn't loaded yet. The Decky Loader may be reloading the plugin in the background." }) }), window.SP_JSX.jsx(window.DFL.PanelSectionRow, { children: window.SP_JSX.jsx(window.DFL.Focusable, { onActivate: () => retryRefreshStatic(), style: {
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            gap: "8px",
...
function SettingsView() {
    ...
    const setTypeChartGen = window.SP_REACT.useCallback(async (v) => {
        try {
